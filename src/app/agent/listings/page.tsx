      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-6 pb-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 border-b border-slate-100 pb-5">
          <div className="space-y-1">
            ...
            <h1 className="text-xl font-black text-slate-900 tracking-tight leading-none uppercase italic">Inventory <span className="text-sky-600">Manager</span></h1>
          ...
          <div className="flex items-center gap-2 w-full md:w-auto">
            <Dialog>
              <DialogTrigger asChild>
                <Button size="sm" className="h-9 px-5 rounded-xl font-black shadow-lg shadow-sky-600/20 bg-sky-600 text-white border-none gap-2 text-[10px] w-full sm:w-auto transition-all hover:scale-105 active:scale-95">
              ...
              <DialogContent className="rounded-[2.5rem] border-none shadow-2xl p-0 overflow-hidden bg-white max-w-[600px] w-[95vw] max-h-[85vh] flex flex-col">
                {/* Fixed Header */}
                <div className="bg-sky-600 p-6 sm:p-8 text-white relative shrink-0">
                  ...
                  <DialogHeader className="relative z-10 text-left">
                    ...
                    <DialogDescription className="text-sky-100 font-bold uppercase tracking-[0.2em] text-[8px] sm:text-[10px] mt-2">
                  ...
                  <div className="p-6 sm:p-8 space-y-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                        {/* Upload Trigger */}
                        <div className="relative group aspect-square rounded-2xl bg-slate-50 border-2 border-dashed border-slate-200 flex flex-col items-center justify-center gap-2 hover:bg-sky-50 hover:border-sky-200 transition-all cursor-pointer overflow-hidden">
                          <PlusCircle className="h-6 w-6 text-slate-300 group-hover:text-sky-600 transition-colors" />
                    ...
                    <div className="p-4 bg-sky-50 rounded-2xl border border-sky-100 flex items-center gap-3">
                      <div className="h-8 w-8 rounded-lg bg-white flex items-center justify-center text-sky-600 shadow-sm shrink-0">
                        <ShieldCheck className="h-4 w-4" />
                      </div>
                      <p className="text-[9px] sm:text-[10px] text-sky-700/70 font-medium leading-relaxed uppercase tracking-wider">
                ...
                <div className="p-6 sm:p-8 bg-slate-50 border-t border-slate-100 shrink-0">
                  <DialogFooter>
                    <Button className="w-full h-14 rounded-2xl bg-sky-600 text-white font-black text-xs uppercase tracking-widest shadow-xl shadow-sky-600/20 hover:bg-sky-700 transition-all">
            ...
            <Card key={item.id} className="rounded-[2.5rem] border-none shadow-sm bg-white overflow-hidden group hover:shadow-xl transition-all duration-500">
              ...
              <CardHeader className="p-6 pb-2">
                <div className="flex justify-between items-start gap-4">
                  <div className="space-y-1 min-w-0">
                    <CardTitle className="text-sm font-black text-slate-900 group-hover:text-sky-600 transition-colors truncate">{item.title}</CardTitle>
                    <div className="flex items-center gap-2 text-[9px] font-bold text-slate-400 uppercase tracking-widest">
                      <MapPin className="h-3 w-3 text-sky-600" /> {item.location}
                    </div>
                  </div>
                  <div className="text-right shrink-0">
                    <p className="text-base font-black text-sky-600 tracking-tighter leading-none italic">€{item.price}</p>
              ...
              <CardContent className="px-6 py-4 space-y-4">
                <div className="flex items-center justify-between p-3 bg-slate-50 rounded-2xl border border-slate-100">
                  ...
                  <Badge variant="outline" className="text-[7px] h-5 px-2 border-sky-100 text-sky-600 font-black uppercase">
                    {item.type}
                  </Badge>
                </div>
